...
class TestApi(TestCase):
    ...
    def test_get_member_photo_with_valid_data(self):
        ...
        self.assertEqual(self.meetup.get_member_photo(), data.get('photo').get('thumb_link'))
    ...
    def test_us_to_utc(self):
        ...
        self.assertEqual(self.meetup._us_to_utc('Tue Jul 30 20:13:35 EDT 2019'), datetime(2019, 7, 31, 0, 13, 35, tzinfo=pytz.utc))
        self.assertEqual(self.meetup._us_to_utc('Sun Jun 16 08:24:49 EDT 2019'), datetime(2019, 6, 16, 12, 24, 49, tzinfo=pytz.utc))
